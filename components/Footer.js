    ...
    >
      ...
      <div className="my-4 text-sm leading-6">
        <div className="flex align-baseline justify-between flex-wrap">
          <p>
            © {BLOG.firstName} {from === y || !from ? y : `${from} - ${y}`}
          </p>
          <div className="grid grid-cols-3 gap-8">
            <a href={BLOG.socialLinks.linkedin} aria-label="Linkedin">
              <svg
            ...
            <a href={BLOG.socialLinks.twitter} aria-label="Twitter">
              <svg
                className="w-6 h-6 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24">
            ...
            <a href={BLOG.socialLinks.github} aria-label="Github">
